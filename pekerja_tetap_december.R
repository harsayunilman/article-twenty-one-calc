...
data <- read.csv("payroll_pekerja_tetap_december.csv")
...
pekerja_tetap_december <-  data.frame(masa_pajak, 
                                     tahun_pajak, 
...
pekerja_tetap_december <- setNames(pekerja_tetap_december, c("Masa Pajak",
                                                           "Tahun Pajak",
                                                           "Pembetulan", 
                                                           "NPWP", 
                                                           "Nama", 
